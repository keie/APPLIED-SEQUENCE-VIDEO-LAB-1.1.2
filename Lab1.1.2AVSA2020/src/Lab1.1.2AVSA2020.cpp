...
//
	string dataset_path = "/home/eps/Escritorio/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "/home/eps/Escritorio/AVSA2020results/"; //SET THIS DIRECTORY according to your project
	string project_name = "Lab1.1.1AVSA2020"; // project exe name
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			//fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, rgb); //construct object of the bgs class //lab1.2
